...
- `causal_learning_analytics`
- `learning_experiment_platform`
- `training_transfer_analytics`

## Why this empirical bundle is distinct
The empirical source is randomized, so the bundle reports the experimental contrast, but its research contribution is decision analysis: how implementation confidence changes with the minimum economically meaningful benefit. It does not build an observational causal estimator, a generic experiment platform, or a workplace transfer model.
